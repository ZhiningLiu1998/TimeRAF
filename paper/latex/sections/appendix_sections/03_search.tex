...
\begin{figure*}[t]
  ...
  ETTh1 MULL example from a trained \timemixer{}. (a) Descriptor search returns
...
\begin{figure*}[t]
\hrule\vspace{2pt}
\textbf{Algorithm 1:} \method{} calibration and forecast-time correcsion\\[1pt]
\hrule\vspace{3pt}
\textbf{Input:} trained forecaster $f$; validation stream
...
\midrule
Identity & Current model prediction only; no labels\\
